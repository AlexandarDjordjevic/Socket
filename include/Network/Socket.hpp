...
public:
  ...
  /**
   * @brief This function is used to establish connection between two network
   * nodes
   *
  ...
  /**
   * @brief This is the function for binding the socket to the address
   * 0.0.0.0(INADDR_ANY)
   *
   * @param port Bind port number
   *
  ...
  /**
   * @brief Set socket into listen state and ready to accept incoming
   * connections.
  ...
  /**
   * @brief This function will cause all or part of a full-duplex connection on
   * the
